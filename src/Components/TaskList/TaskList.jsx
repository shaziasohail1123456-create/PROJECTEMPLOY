...
//   // Ek hi master function jo status handle karega
...
//   return (
//     <div className="mt-10">
//       <h2 className="text-white text-2xl font-semibold mb-5 px-5">Your Tasks</h2>
//       <div className="flex gap-5 overflow-x-auto pb-10 px-5 scrollbar-hide">
//         {data.tasks.map((task, index) => (
//           <div key={index} className="min-w-[300px] bg-[#2a2a2a] p-6 rounded-2xl shadow-xl border border-gray-800 flex flex-col justify-between">
//             <div>
//               <div className="flex justify-between items-center mb-4">
//                 <span className="bg-emerald-500 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">{task.category}</span>
//                 <span className="text-gray-400 text-xs font-medium">{task.date}</span>
//               </div>
...
//               {task.newTask && (
//                 <button onClick={() => updateTaskStatus(task.title, 'active')} className='w-full bg-indigo-600 hover:bg-indigo-700 py-2 rounded-lg text-sm font-semibold text-white transition-all'>Accept Task</button>
//               )}

//               {task.active && (
//                 <div className='flex gap-2 w-full'>
//                   <button onClick={() => updateTaskStatus(task.title, 'completed')} className='flex-1 bg-green-600 hover:bg-green-700 py-2 rounded-lg text-xs font-bold text-white uppercase'>Complete</button>
//                   <button onClick={() => updateTaskStatus(task.title, 'failed')} className='flex-1 bg-red-600 hover:bg-red-700 py-2 rounded-lg text-xs font-bold text-white uppercase'>Fail</button>
//                 </div>
//               )}

//               {task.completed && (
//               <div className='w-full text-center bg-gray-800 py-2 rounded-lg border border-green-500/30'>
//                    <span className='text-green-400 text-xs font-bold uppercase'>Task Completed ✅</span>
//                 </div>
//               )}

//               {task.failed && (
//                 <div className='w-full text-center bg-gray-800 py-2 rounded-lg border border-red-500/30'>
