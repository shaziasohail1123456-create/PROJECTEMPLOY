...
const FailedTask = ({data, setUserData, userData, loggedInUser}) => {
    ...
    return (
        <div className='flex-shrink-0 h-full w-[300px] p-5 bg-red-400 rounded-xl'>
            ...
            <div className='mt-6'>
                <button onClick={handleFailed} className='w-full bg-red-600 py-1 px-2 text-sm rounded'>Failed</button>
            </div>
        </div>
    )
}
